...
I am a Pyrogram String Session generator bot.
...
buttons = [
    ...
    InlineKeyboardButton(
        "📃 More Bots", url="https://t.me/szbots/8"),
    InlineKeyboardButton(
...
async def generate_str(c, m):
    ...
    try:
        ...
        text = "✅ Congratulations! Successfully Generated Your Pyrogram String Session and sent to you saved messages.\nCheck your saved messages or Click on Below Button."
...
If bot not Sending OTP to your Phone Number than send /cancle Command and again send /start to Start your Process. 
...
__📃 More bots:__ [TG Bots](https://t.me/szbots/8)

__📢 Channel:__ [BOT UPDATES](https://t.me/szbots)

__👥 Group:__ [BOT SUPPORT](https://t.me/slbotzone)
"""
